...
Şartlar veya gizlilik metni değişirse uygulama içinde veya uygun başka bir kanalla bilgilendirme yapılabilir. Önemli değişikliklerde tekrar onay istenebilir. Sorular için destek kanalından bizimle iletişime geçebilirsin.''',
    ...
    'appLock.headerBody':
        'Android MVP kullanım erişimi, üst ekran ve konum kurallarını kullanır.',
    ...
    'appLock.permissionsBody':
        'Kullanım erişimi, üst ekran ve konum izinlerini ver.',
    ...
    'appLock.open': 'Aç',
    'appLock.androidOnly':
        'Bu MVP Android içindir; iOS için Apple entitlement süreci gerekir.',
    ...
    'appLock.strictLocation':
        'Konumdayken odakla açmayı engelle; kural kaldırılınca açılır.',
    ...
    'appLock.iosRoadmapTitle': 'iOS yol haritası',
    'appLock.iosRoadmapBody':
        'iOS tarafında overlay yok; FamilyControls, ManagedSettings ve DeviceActivity onayı sonrası Apple shield ekranı kullanılacak.',

    'settings.widgetSettingsTitle': 'Widget Ayarları',
    'settings.widgetSettingsBody': 'Ana ekran widget\'larını ve kısayollarını yapılandırın.',
...
If these terms or privacy rules change, we may notify you in the app or by another appropriate channel. Material changes may require acceptance again. For questions, contact support through the app.''',
    ...
    'settings.widgetSettingsBody': 'Configure home screen widgets and shortcuts.',
