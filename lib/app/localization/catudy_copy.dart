class CatudyCopy {
  ...
  static const _tr = <String, String>{
    ...
    'update.connecting': 'Bağlanıyor...',
    'update.error': 'İndirme başarısız oldu. İnternet bağlantını kontrol et.',
    'update.downloaded': 'İndirildi. Yükleme ekranı açılıyor...',
    'update.later': 'Sonra',
    'update.retry': 'Tekrar dene',
    'update.downloadAndInstall': 'İndir ve güncelle',
...
Şartlar veya gizlilik metni değişirse uygulama içinde veya uygun başka bir kanalla bilgilendirme yapılabilir. Önemli değişikliklerde tekrar onay istenebilir. Sorular için destek kanalından bizimle iletişime geçebilirsin.''',
    ...
    'home.quickReminderHint': 'Hızlı hatırlatma ekle',
    'home.quickReminderAdd': 'Hatırlatma ekle',
    ...
    'inventory.category.cats': 'Kediler',
    ...
    'premium.pitch': 'Plus ile daha fazlası',
    'premium.heroTitle': 'Plus',
    'premium.heroHeadline': 'Daha fazla avantaj.',
    'premium.heroAccent': 'Daha sade odak.',
    'premium.heroBody': 'Tema, istatistik, sezon.',
    'premium.whatYouGet': 'Neler var',
    'premium.benefitRoomsTitle': 'Oda temaları',
    'premium.benefitRoomsBody': 'Plus odalar.',
    'premium.benefitPetTitle': 'Pet görünümü',
    'premium.benefitPetBody': 'Özel stiller.',
    'premium.benefitSeasonTitle': 'Sezon',
    'premium.benefitSeasonBody': 'Bonus ödüller.',
    'premium.benefitStatsTitle': 'İstatistik',
    'premium.benefitStatsBody': 'Detaylı grafikler.',
    'premium.benefitSoundTitle': 'Sesler',
    'premium.benefitSoundBody': 'Sakin sesler.',
    'premium.benefitEarlyTitle': 'Erken erişim',
    'premium.benefitEarlyBody': 'Yeni özellikler.',
    'premium.freeColumn': 'Free',
    'premium.plusColumn': 'Plus',
    'premium.featureColumn': 'Özellik',
    'premium.compareRooms': 'Oda temaları',
    'premium.comparePet': 'Pet kozmetikleri',
    'premium.compareSeason': 'Sezon ödülleri',
    'premium.compareStats': 'İstatistik',
    'premium.compareBadges': 'Özel rozetler',
    'premium.compareAll': 'Hepsi',
    'premium.compareBasic': 'Temel',
    'premium.compareExclusive': 'Özel',
    'premium.compareAdvanced': 'Detaylı',
    'premium.monthly': 'Aylık',
    'premium.yearly': 'Yıllık',
    'premium.monthlyPrice': '67 TL / ay',
    'premium.yearlyPrice': '670 TL / yıl',
    'premium.bestValue': 'Avantajlı',
    'premium.trialCta': 'Plus\'a geç',
    'premium.cancelAnytime': 'Taahhüt yok.',
    'premium.body': 'Koç, istatistik, sezon ve kozmetik.',
    ...
    'premium.refresh': 'Yenile',

    'buddy.title': 'Buddy Pass',
    'buddy.body': 'Ayda 1 kez 30 günlük pass gönder.',
    'buddy.requirements': 'Alıcı Plus olmayan farklı bir hesap olmalı.',
    'buddy.copy': 'Kopyala',
    ...
    'settings.profileStatsVisibilityBody':
        'Kapalıysa süre, seri ve seans gizlenir.',
    ...
    'settings.focusDnd': 'Odakta telefonu rahatsız etmeyine al',
    'settings.focusDndBody':
        'Odak başlayınca DND açılır, seans bitince eski durum geri yüklenir.',
    'settings.focusDndPermissionBody':
        'Android için Bildirim Politikası erişimi gerekiyor.',
    'settings.openDndAccess': 'DND iznini aç',
    ...
    'settings.offline': 'Veriler bu cihazda.',
    ...
    'settings.deleteAccountBody': 'Hesap ve Catudy verileri kalıcı silinir.',
    'settings.deleteAccountConfirm': 'Hesabı sil',
    'settings.demoWallet': 'Demo Bakiyesi',
    'settings.demoWalletBody': 'Coin 5000, puan 2500 olur. Eşyalar kalır.',
    ...
    'appLock.headerBody': 'Seçili uygulamalar odak bitene kadar kapalı.',
    'appLock.masterSwitch': 'Uygulama kilidi aktif',
    'appLock.masterSwitchBody': 'Kapalıyken kilitler çalışmaz.',
    'appLock.permissions': 'İzinler',
    'appLock.permissionsBody': 'Gerekli izinleri kontrol et.',
    ...
    'appLock.currentLocationUnavailable': 'Konum alınamadı. Haritadan seç.',
    'appLock.tapMapHint': 'Haritaya dokunarak konumu seç.',
    'appLock.expandMap': 'Haritayı büyüt',
    'appLock.collapseMap': 'Haritayı küçült',
    ...
    'settings.widgetSettingsTitle': 'Widget',
    'settings.widgetSettingsBody': 'Widget ve kısayollar.',
    ...
    'widget.swipeHint': 'Sağa kaydır',
    'widget.configurations': 'Seçenek',
    'widget.optionsPetTitle': 'Pet',
    'widget.optionsGoalTitle': 'Hedef',
    'widget.optionsShortcutTitle': 'Kısayol',
    'widget.optionsStreakTitle': 'Seri',
    'widget.optionsGoalBody': 'Günlük hedefi gösterir.',
    'widget.optionsStreakBody': 'Seri ve bugün.',
    'widget.petMood': 'Mod',
  ...
  static const _en = <String, String>{
    ...
    'update.error': 'Download failed. Check your internet connection.',
    'update.downloaded': 'Downloaded. The installer is opening...',
    'update.later': 'Later',
    'update.retry': 'Try again',
    'update.downloadAndInstall': 'Download and update',
...
If these terms or privacy rules change, we may notify you in the app or by another appropriate channel. Material changes may require acceptance again. For questions, contact support through the app.''',
    ...
    'home.quickReminderHint': 'Add quick reminder',
    'home.quickReminderAdd': 'Add reminder',
    ...
    'stats.averageSessionInfo': 'Average: {minutes} min.',
    ...
    'premium.pitch': 'More with Plus',
    'premium.heroTitle': 'Plus',
    'premium.heroHeadline': 'More perks.',
    'premium.heroAccent': 'Cleaner focus.',
    'premium.heroBody': 'Themes, stats, season.',
    'premium.whatYouGet': 'What you get',
    'premium.benefitRoomsTitle': 'Room themes',
    'premium.benefitRoomsBody': 'Plus rooms.',
    'premium.benefitPetTitle': 'Pet looks',
    'premium.benefitPetBody': 'Premium styles.',
    'premium.benefitSeasonTitle': 'Season',
    'premium.benefitSeasonBody': 'Bonus rewards.',
    'premium.benefitStatsTitle': 'Stats',
    'premium.benefitStatsBody': 'Deeper charts.',
    'premium.benefitSoundTitle': 'Sounds',
    'premium.benefitSoundBody': 'Calm audio.',
    'premium.benefitEarlyTitle': 'Early access',
    'premium.benefitEarlyBody': 'New features.',
    'premium.freeColumn': 'Free',
    'premium.plusColumn': 'Plus',
    'premium.featureColumn': 'Feature',
    'premium.compareRooms': 'Room themes',
    'premium.comparePet': 'Pet cosmetics',
    'premium.compareSeason': 'Season rewards',
    'premium.compareStats': 'Stats',
    'premium.compareBadges': 'Special badges',
    'premium.compareAll': 'All',
    'premium.compareBasic': 'Basic',
    'premium.compareExclusive': 'Exclusive',
    'premium.compareAdvanced': 'Detailed',
    'premium.monthly': 'Monthly',
    'premium.yearly': 'Yearly',
    'premium.monthlyPrice': '\$2 / month',
    'premium.yearlyPrice': '\$20 / year',
    'premium.bestValue': 'Best value',
    'premium.trialCta': 'Enable Plus',
    'premium.cancelAnytime': 'No commitment.',
    'premium.body': 'Coach, stats, season, cosmetics.',
    ...
    'buddy.title': 'Buddy Pass',
    'buddy.body': 'Send one 30-day pass each month.',
    'buddy.requirements': 'Receiver must be a different non-Plus account.',
    'buddy.copy': 'Copy',
    ...
    'settings.profileStatsVisibilityBody':
        'When off, time, streak, and sessions are hidden.',
    ...
    'settings.focusDnd': 'Turn on Do Not Disturb during focus',
    'settings.focusDndBody':
        'DND turns on when focus starts and restores when the session ends.',
    'settings.focusDndPermissionBody':
        'Android needs Notification Policy access for this.',
    'settings.openDndAccess': 'Open DND access',
    ...
    'settings.offline': 'Data stays on this device.',
    ...
    'settings.deleteAccountBody':
        'Account and Catudy data will be permanently deleted.',
    'settings.deleteAccountConfirm': 'Delete account',
    'settings.demoWallet': 'Demo Wallet',
    'settings.demoWalletBody':
        'Sets coin to 5000 and points to 2500. Items stay.',
    ...
    'appLock.headerBody': 'Selected apps stay closed until focus ends.',
    'appLock.masterSwitch': 'App lock enabled',
    'appLock.masterSwitchBody': 'When off, locks are inactive.',
    'appLock.permissions': 'Permissions',
    'appLock.permissionsBody': 'Check required permissions.',
    ...
    'appLock.currentLocationUnavailable':
        'Could not read location. Pick on map.',
    'appLock.tapMapHint': 'Tap the map to choose the location.',
    'appLock.expandMap': 'Expand map',
    'appLock.collapseMap': 'Collapse map',
    ...
    'settings.widgetSettingsTitle': 'Widgets',
    'settings.widgetSettingsBody': 'Widgets and shortcuts.',
    ...
    'widget.swipeHint': 'Swipe to choose',
    'widget.configurations': 'Options',
    'widget.optionsPetTitle': 'Pet',
    'widget.optionsGoalTitle': 'Goal',
    'widget.optionsShortcutTitle': 'Shortcut',
    'widget.optionsStreakTitle': 'Streak',
    'widget.optionsGoalBody': 'Shows daily goal.',
    'widget.optionsStreakBody': 'Streak and today.',
    'widget.petMood': 'Mood',
